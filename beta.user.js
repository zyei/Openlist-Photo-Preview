...
(function() {
    ...
    GM_addStyle(`
        ...
        /* [v16.1] 控件自动隐藏逻辑 */
        .gallery-back-btn, .gallery-toolbar {
            opacity: 0;
            visibility: hidden;
            transform: translateY(-20px);
            transition: opacity 0.4s var(--ease-out-quart), visibility 0.4s var(--ease-out-quart), transform 0.4s var(--ease-out-quart);
        }
        #${GALLERY_CONTAINER_ID}:hover .gallery-back-btn,
        #${GALLERY_CONTAINER_ID}:hover .gallery-toolbar,
        .gallery-back-btn.controls-visible,
        .gallery-toolbar.controls-visible {
            opacity: 1;
            visibility: visible;
            ...
            <div class="gallery-scroll-container">
                ...
                <div class="gallery-toolbar">
                    ...
                    <button class="toolbar-btn" id="gallery-fullscreen-btn" title="全屏 (F)">
                        <svg class="enter-fullscreen-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8 3H5a2 2 0 0 0-2 2v3m18 0V5a2 2 0 0 0-2-2h-3m0 18h3a2 2 0 0 0 2-2v-3M3 16v3a2 2 0 0 0 2 2h3"/></svg>
                        <svg class="exit-fullscreen-icon" style="display:none;" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8 3v3a2 2 0 0 1-2 2H3m18 0h-3a2 2 0 0 1-2-2V3m0 18v-3a2 2 0 0 0-2-2H8M3 16h3a2 2 0 0 0 2-2v-3"/></svg>
                    </button>
                </div>
